...
const STORAGE_KEY = 'archmindcanvas-v4-2';
...
function Designer(){
  ...
  const exportJson=()=>downloadBlob(new Blob([JSON.stringify({version:'4.2',designName,nodes,edges},null,2)],{type:'application/json'}),`${designName.replace(/[^a-z0-9]+/gi,'-').toLowerCase()}-design.json`);
