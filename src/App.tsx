...
import { Check, Clipboard, Copy, Download, FilePlus2, FolderOpen, Maximize2, Redo2, Save, ShieldCheck, Sparkles, Undo2, MousePointer2, Route, Square, Triangle, Type, Trash2, Bot, Code2, DollarSign, Image, FileText } from 'lucide-react';
