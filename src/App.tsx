...
import { Check, Clipboard, Copy, Download, FilePlus2, FolderOpen, Maximize2, Redo2, Save, ShieldCheck, Sparkles, Undo2, UploadCloud, MousePointer2, Route, Square, Triangle, Type, Trash2, Bot, Code2, DollarSign } from 'lucide-react';
...
function Designer(){
 ...
 const [iacImportType,setIacImportType]=useState<'terraform'|'bicep'>('terraform');
 ...
 const uploadIacFile=()=>{
  ...
  input.onchange=async()=>{
    ...
    try{
      ...
      if(name.endsWith('.bicep'))setIacImportType('bicep');
      else setIacImportType('terraform');
      setRightPanel('import');
    }catch{
      alert('Unable to read IaC file.');
    }
  };
  input.click();
 };
