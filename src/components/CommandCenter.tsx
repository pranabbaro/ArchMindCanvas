...
import {
  Activity, Archive, Boxes, Building2, ChevronLeft, ChevronRight, CircleCheck, Cloud,
  ...
  return <div className="command-center-shell">
    <aside className="command-sidebar">
      ...
      <nav className="command-nav">
        ...
        <button className={view==='templates'?'active':''} onClick={()=>setView('templates')}><Boxes size={16}/><span>Templates</span><em>{templates.length}</em></button>
