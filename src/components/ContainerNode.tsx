...
export default function ContainerNode({ data, selected }: NodeProps<ArchitectureNode>) {
  const item=resourceMap[data.resourceType]; const Icon=item.fallbackIcon; const [iconFailed,setIconFailed]=useState(false); const useFallback=iconFailed||!item.iconUrl; const m=minSize[data.resourceType]||{w:300,h:220};
  return <>
